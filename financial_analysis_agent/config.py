...
class Config:
    ...
    def __init__(self):
        ...
        self._config = {
            ...
            'paths': {
                'data': os.getenv('DATA_DIR', str(Path(__file__).parent.parent / 'data')),
                'cache': os.getenv('CACHE_DIR', str(Path(__file__).parent.parent / '.cache')),
            },
            'apis': {
                'alpha_vantage': {
                ...
                'reddit': {
                    ...
                    'user_agent': os.getenv('REDDIT_USER_AGENT', 'FinancialAnalysisAgent/0.1'),
